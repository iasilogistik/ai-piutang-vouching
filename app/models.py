...
class SAPBilling(Base):
    ...
    __table_args__ = (
        UniqueConstraint("import_batch_id", "billing_document", name="uq_sap_billing_batch_document"),
        Index("ix_sap_billing_billing_document", "billing_document"),
    )
...
class BillingReconciliation(Base):
    ...
    __table_args__ = (
        UniqueConstraint("sap_billing_id", name="uq_billing_reconciliation_sap"),
        UniqueConstraint("physical_billing_id", name="uq_billing_reconciliation_physical"),
        Index("ix_billing_reconciliation_status", "status"),
    )
...
class VouchingResult(Base):
    ...
    __table_args__ = (
        UniqueConstraint("billing_id", name="uq_vouching_result_billing"),
        Index("ix_vouching_result_status", "status"),
    )
